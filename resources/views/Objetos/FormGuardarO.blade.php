...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            @csrf
            <input type="text" name="id_objeto" id="id_objeto" placeholder="Id_Objeto">
            <input type="text" name="nombre_objeto" id="nombre_objeto" placeholder="Nombre_Objeto">
