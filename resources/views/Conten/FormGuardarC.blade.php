...
<head>
    ...
    <title>Guardar Contenedor</title>
...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            <h3>Registro De Contenedores</h3>
            ...
            @csrf
            <input type="text" name="lugar" id="lugar" placeholder="Lugares">
            <input type="text" name="tipo_conten" id="tipo_conten" placeholder="Tipos Contenedores">
